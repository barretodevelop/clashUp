...
class AuthService {
  ...
  static Future<User?> signInWithGoogle() async {
    ...
    try {
      ...
      // User model creation/retrieval is now handled by UserProvider
      stopwatch.stop();

      if (firebaseUser != null) {
        // Check if Firebase user is successfully authenticated
    ...
    try {
      ...
      if (existingUser != null) {
        ...
        await _trackAuthEvent('existing_user_loaded', {
          ...
          'account_age_days':
              DateTime.now().difference(existingUser.createdAt).inDays,
        });
